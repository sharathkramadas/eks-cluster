...
resource "aws_iam_role_policy_attachment" "role_policy_attachment-AmazonEKSClusterPolicy" {
  policy_arn = "arn:aws:iam::aws:policy/AmazonEKSClusterPolicy"
  role       = aws_iam_role.cluster_role.name
}

resource "aws_iam_role_policy_attachment" "role_policy_attachment-AmazonEKSVPCResourceController" {
